...
-- generates, for each type generated by `interpretSubst0Alg`, a functor
-- which maps given constraints on those types to new constraints on those
-- types.
public export
subst0ConstraintAlg : Subst0TypeAlg (Type -> Type)
subst0ConstraintAlg = CoproductAlgL {l=Subst0TypeFCases}
  (
